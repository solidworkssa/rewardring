# 29-rewardring - Base Native Architecture
...
Circular economy rewards system

## Overview

RewardRing provides a decentralized solution for token rewards for participation on both Base (EVM) and Stacks blockchains.
